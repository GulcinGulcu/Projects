...
export const RecentActivities = () => {
    ...
    return (
        <section className="home__recent-activities">
            ...
            <ul className={isDarkMode ? 'home__recent-activities__list dark' : 'home__recent-activities__list'}>
                {recentActivities.map(activity => {
                    return (
                        <>
                            <li className="home__recent-activities__list-item" key={activity.id}><span>{active && activeId === activity.id ? <SlArrowDown /> : <SlArrowRight />} 
